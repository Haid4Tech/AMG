      ...
      <div className="relative bg-gradient-to-br from-main-50 to-main-100 py-20 px-6 md:px-10 lg:px-26 2xl:px-54">
        <div className="max-w-6xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-main-700 max-w-4xl mx-auto leading-relaxed">
            Ready to discuss your sustainable energy needs? We're here to help you 
            transform your energy infrastructure with AMG's innovative solutions.
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <div key={index} className="bg-white p-8 rounded-2xl shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
                ...
                <h3 className="text-xl font-bold text-main-900 mb-4">{contact.title}</h3>
                <div className="space-y-2 mb-3">
                  {contact.details.map((detail, detailIndex) => (
                    <p key={detailIndex} className="text-main-700 font-medium">{detail}</p>
                  ))}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-main-700 mb-2">
                      Full Name *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-main-700 mb-2">
                      Email Address *
                    </label>
                    <input
                      type="email"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="company" className="block text-sm font-medium text-main-700 mb-2">
                      Company
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-main-700 mb-2">
                      Subject *
                    </label>
                    <select
                      id="subject"
                    ...
                    >
                      ...
                      <option value="amg-proyten">AMG Proyten Hybrid Synchronizer</option>
                    </select>
                  </div>
                </div>
                
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-main-700 mb-2">
                    Message *
                  </label>
                  <textarea
                    id="message"
            ...
            <div className="space-y-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                <h3 className="text-2xl font-bold text-main-900 mb-6">Visit Our Office</h3>
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <MapPin className="w-6 h-6 text-main-600 mt-1 flex-shrink-0" />
                    <div>
                      <p className="font-semibold text-main-900">AMG Energy Storage Headquarters</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-main-900">Business Hours</p>
                      <p className="text-main-700">Monday - Friday: 8:00 AM - 6:00 PM</p>
                      <p className="text-main-700">Saturday: 9:00 AM - 2:00 PM</p>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                answer: "Yes, we provide complimentary initial consultations to understand your energy needs and discuss potential solutions."
              },
              {
                question: "What areas do you serve?",
                answer: "We primarily serve Nigeria and West Africa, with plans to expand across the continent. We also work with international partners."
              },
              {
                question: "Can you work with existing energy infrastructure?",
                answer: "Absolutely! We specialize in upgrading and optimizing existing energy systems to improve efficiency and sustainability."
              },
              {
                question: "Tell me more about the AMG Proyten Hybrid Synchronizer",
                answer: "The AMG Proyten Hybrid Synchronizer is our flagship product that enables seamless integration of multiple energy sources for optimal efficiency and reliability."
              }
            ].map((faq, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-lg">
                <h3 className="text-lg font-semibold text-main-900 mb-3">{faq.question}</h3>
      ...
      <div className="py-20 px-6 md:px-10 lg:px-26 2xl:px-54 bg-main-900">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl text-main-100 mb-8 leading-relaxed">
            Don't wait to transform your energy infrastructure. Contact AMG today 
            and take the first step toward a sustainable future.
          </p>
